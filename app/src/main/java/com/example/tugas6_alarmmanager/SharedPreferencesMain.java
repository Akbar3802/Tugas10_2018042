...
import com.example.tugas6_alarmmanager.databinding.ActivitySharedpreferencesBinding;


public class SharedPreferencesMain extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            Intent intent = new Intent(SharedPreferencesMain.this, Dashboard.class);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.Signinbuttonid) {
            ...
            Intent intent = new Intent(SharedPreferencesMain.this, activity_register.class);
            startActivity(intent);
        }
    }
}